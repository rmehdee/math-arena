/* Math Arena. All state lives in this browser. Nothing is ever sent anywhere. */
(function () {
  'use strict';
  const KEY = 'matharena.v1';
  ...
  function openReport() {
    ...
    $('reportBody').innerHTML = `
      ...
      <p class="small muted" style="margin-top:12px">Aligned to Florida's B.E.S.T. mathematics benchmarks. Practice tool only, not an official assessment.</p>`;
  }
  ...
  function downloadReport() {
    ...
    x.fillStyle = '#fff';
    x.font = '800 40px system-ui, sans-serif'; x.fillText('Math Arena Report Card', 44, 62);
    x.font = '600 20px system-ui, sans-serif';
    x.fillText('Grade ' + me.grade + ' · Florida B.E.S.T. benchmarks', 44, 96);
    ...
    x.fillText('Practice tool aligned to Florida B.E.S.T. benchmarks. Not an official assessment.', 44, H - 30);
